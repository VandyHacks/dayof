...
var publicKey = 'BLG1-QasBcbWCAShq_GBT-H_Dmb4gdR3pjUyBhzHYNrPjkoJcQgwHut_D3MGL0c6mbM3BPreabClVFMGPQHx9h0';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            console.log('Registered service worker'); // Register Push
          ...
          case 11:
            ...
            console.log('Registered push'); // Send PushSubscription to backend
          ...
          case 15:
            ...
            }).then(console.log('Fetched')).catch(function (err) {
