...
function exists(subscription) {
  console.log(PushSub.findOne({ endpoint: subscription.endpoint, key: subscription.key }));
  return PushSub.findOne({ endpoint: subscription.endpoint, key: subscription.key });
}
