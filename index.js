...
function isValidSaveRequest(req, res) {
  ...
  return PushSub.countDocuments({ endpoint: req.body.endpoint, key: req.body.key });
}
...
app.post('/sendpush', (req, res) => {
  ...
  const payload = JSON.stringify({ title: 'VandyHacks', body: message }); // eslint-disable-line changed message to req.body
